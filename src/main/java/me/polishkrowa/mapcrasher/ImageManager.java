...
public class ImageManager implements Listener {
    ...
    private CustomFile dataFile = new CustomFile("maps.yml");
     ...
     */
    public void init() {
        Bukkit.getServer().getPluginManager().registerEvents(this, MapCrasher.getPlugin(MapCrasher.class));
        loadImages();
    }
    ...
    class CustomFile {
        ...
        private final MapCrasher plugin = MapCrasher.getPlugin(MapCrasher.class);
